...
<div class="container">
    ...
    <div class="mb-8">
        <div class="col col-lg-4">
            ...
            <input type="hidden" name="kode_obat" class="form-control" value="<?php echo $id;?>" required>
            <input type="text" class="form-control" value="<?php echo htmlentities($result['kode_obat']);?>" name="kode_obat" id="kode_obat" required>
        </div>

        <div class="col col-lg-4">
            <label for="exampleFormControlInput1" class="form-label">Nama Obat</label>
            <input type="text" class="form-control" value="<?php echo htmlentities($result['nama_obat']);?>" name="nama_obat" id="nama_obat" required>
        </div>
