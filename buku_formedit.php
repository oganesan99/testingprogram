...
<h1 h1 style="text-align:center">Update Data Buku</h1>
<div class="container">
    <form method="post" name="theform" action="buku_prosesedit.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
    <?php
	    $id=$_GET['kode_buku'];
		$sql ="SELECT * FROM data_buku WHERE kode_buku='$id'";
    ...
    <div class="mb-8">
        <div class="col col-lg-4">
            ...
            <input type="hidden" name="kode_buku" class="form-control" value="<?php echo $id;?>" required>
            <input type="text" class="form-control" value="<?php echo htmlentities($result['kode_buku']);?>" name="kode_buku" id="kode_buku" required>
        </div>

        <div class="col col-lg-4">
            <label for="exampleFormControlInput1" class="form-label">Judul Buku</label>
            <input type="text" class="form-control" value="<?php echo htmlentities($result['judul_buku']);?>" name="judul_buku" id="judul_buku" required>
        </div>

        <div class="col col-lg-4">
            <label for="exampleFormControlInput1" class="form-label">Pengarang</label>
            <input type="text" class="form-control" value="<?php echo htmlentities($result['pengarang']);?>" name="pengarang" id="pengarang" required>
        </div>
